...
module.exports = {
  'align': {
    ...
    'right': __webpack_require__(101),
    'justify': __webpack_require__(102)
  },
  'background': __webpack_require__(103),
  'blockquote': __webpack_require__(104),
  'bold': __webpack_require__(105),
  'clean': __webpack_require__(106),
  'code': __webpack_require__(79),
  'code-block': __webpack_require__(79),
  'color': __webpack_require__(107),
  'direction': {
    '': __webpack_require__(108),
    'rtl': __webpack_require__(109)
  },
  'float': {
    'center': __webpack_require__(110),
    'full': __webpack_require__(111),
    'left': __webpack_require__(112),
    'right': __webpack_require__(113)
  },
  'formula': __webpack_require__(114),
  'header': {
    '1': __webpack_require__(115),
    '2': __webpack_require__(116)
  },
  ...
  'lineHeight': __webpack_require__(121),
...
var _lineHeightPicker = __webpack_require__(81);

var _lineHeightPicker2 = _interopRequireDefault(_lineHeightPicker);
...
var LINE_HEIGHTS = ['1', '1.15', '1.5', '2', '2.5', '3'];
    ...
    value: function buildPickers(selects, icons) {
      ...
      this.pickers = selects.map(function (select) {
        if (select.classList.contains('ql-align')) {
          ...
          return new _lineHeightPicker2.default(select, icons.lineHeight);
        } else {
          if (select.querySelector('option') == null) {
...
var LineHeightPicker = function (_Picker) {
  _inherits(LineHeightPicker, _Picker);

  function LineHeightPicker(select, label) {
    _classCallCheck(this, LineHeightPicker);

    var _this = _possibleConstructorReturn(this, (LineHeightPicker.__proto__ || Object.getPrototypeOf(LineHeightPicker)).call(this, select));
...
exports.default = LineHeightPicker;
...
var _lineheight = __webpack_require__(90);
...
var _script = __webpack_require__(92);
...
var _underline = __webpack_require__(94);
...
var _formula = __webpack_require__(97);

var _formula2 = _interopRequireDefault(_formula);

var _syntax = __webpack_require__(98);
...
_core2.default.register({
  ...
  'attributors/class/line-height': _lineheight2.default,
...
_core2.default.register({
  ...
  'formats/line-height': _lineheight2.default,
  ...
  'ui/line-height-picker': _lineHeightPicker2.default,
...
var LineHeightClass = function (_Attributor$Class) {
  ...
  function LineHeightClass() {
    ...
    return _possibleConstructorReturn(this, (LineHeightClass.__proto__ || Object.getPrototypeOf(LineHeightClass)).apply(this, arguments));
  }

  _createClass(LineHeightClass, [{
    key: 'add',
    value: function add(node, value) {
      if (!this.canAdd(node, value)) return false;
      this.remove(node);
      var underscoredValue = value.replace('.', '_');
...
module.exports = "<svg viewBox=\"0 0 18 18\"> <path d=\"M9 15h9v-2H9v2zM9 3v2h9V3H9zM7.5 5L4 1.5.5 5H3v8H.5L4 16.5 7.5 13H5V5h2.5zM9 10h9V8H9v2z\"/> </svg> ";
